...
<body>
    <header> 
        <nav class="navbar">
            ...
            <ul class="nav-links">
                <li><a href="#" class="btn">Editar</a></li>
                <li><a href="#" class="btn">Apagar</a></li>
    ...
    <div class="main-content">
        ...
        <div class="player-section">
            ...
            <img id="player-cover" src="https://via.placeholder.com/250" alt="Capa da Música">
            
            <h2 id="player-title">Título da Música</h2>
            <h4 id="player-author">Autor</h4>
            ...
            <div class="player-controls">
                ...
                <svg viewBox="0 0 24 24" class="icon" onclick="prevSong()"><path d="M6 6h2v12H6zm3.5 6l8.5 6V6z"/></svg>
                
                <svg viewBox="0 0 24 24" class="icon icon-large"><path d="M6 19h4V5H6v14zm8-14v14h4V5h-4z"/></svg>
                
                <svg viewBox="0 0 24 24" class="icon" onclick="nextSong()"><path d="M6 18l8.5-6L6 6v12zM16 6v12h2V6h-2z"/></svg>
    ...
    <script>
        const playlist = <?php echo json_encode($musicas); ?>;
        let currentIndex = 0;
        ...
        function loadSong(index) {
            ...
            document.getElementById('player-cover').src = song.imagem || 'https://via.placeholder.com/250';
            document.getElementById('player-title').innerText = song.titulo || 'Sem Título';
            document.getElementById('player-author').innerText = song.autor || 'Desconhecido';
        }
